<%-- 
    Document   : 404
    Created on : 7 Feb, 2021, 11:05:35 AM
    Author     : DELL
--%>
        ...
        <div id="content_body" class="content_body">
            <div class="content" style="padding: 0">
                <div id="content_div" class="content_div">
                    ...
                    <div class="div-404" style="height: fit-content;padding-bottom: 15px;padding-top: 90px;">
                        <div class="div-shoe-error-404">
                            UH OH! You're lost.
                        </div>                           
                        <div class="div-shoe-error-404" style="font-size: 1.2em;">
                            The page you are looking for does not exist.

                        </div>        
                        <div class="div-shoe-error-404" style="font-size: 2em;">
        ...
        <footer>
            <div class="main_footer">
                <div class="footer_div">
                    <div class="footer_div_text_1">
                        <p>© 
                            <span id="year"></span> 
                            <span class="footer-w-n">
                                <a href="javascript:void(0);"> NEWSPRING .</a>
                            </span>
                            <span class="div_break">All Rights Reserved .</span>
                        </p>
                    </div>
                    <div class="footer_div_text_2">
                        <p class="space_p">
                            <span>Designed By :- </span> 
                            <span class="div_break">
                                Subir Ghosh | Sneha Paul | Arnab Seal
                            </span>
                        </p>
                    </div>
                </div>
