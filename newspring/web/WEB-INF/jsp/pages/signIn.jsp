...
<div id="sign_in_div" class="div_login" style="display:none;">
        ...
        <div class="scrollable" style="border:1px solid red;">			
            <div class="container-login"> 
                <div class="form">
                    ...
                    <div class="name-div">
                        <span class="show_password"><i id="create_s_p" class="fa fa-eye-slash"></i></span>
                        <input id="create_p" type="password" name="password" autocomplete="off" required>
                    ...
                    <div class="name-div">
                        <span class="show_password"><i id="create_sh_p" class="fa fa-eye-slash"></i></span>
                        <input id="create_p1" type="password" name="con-password" autocomplete="off" required>
            ...
            <div class="container-login container-login-b"> 
                <div class="form" style="height:160px;padding-bottom: 10px;">
                    <span class="text_login">
                        <p class="text">Or</p>
                        <p class="text">Login With Your Social Media Account</p>
                    </span>
